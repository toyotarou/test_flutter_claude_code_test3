...
class HorseSearchResultDialog extends StatefulWidget {
  const HorseSearchResultDialog({super.key, required this.hourseName});

  final String hourseName;

  @override
  State<HorseSearchResultDialog> createState() =>
      HorseSearchResultDialogState();
}

class HorseSearchResultDialogState extends State<HorseSearchResultDialog> {
